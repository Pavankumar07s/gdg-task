...
import TestimonialImg01 from "@/GDSC-Assets-master/logos/gdg.png";

import GDSCImg01 from "@/public/images/client-logo-01.svg";
import GDSCImg02 from "@/public/images/client-logo-02.svg";
import GDSCImg03 from "@/public/images/client-logo-03.svg";
import GDSCImg04 from "@/public/images/client-logo-04.svg";
import GDSCImg05 from "@/public/images/client-logo-05.svg";
import GDSCImg06 from "@/public/images/client-logo-06.svg";
import GDSCImg07 from "@/public/images/client-logo-07.svg";
import GDSCImg08 from "@/public/images/client-logo-08.svg";
import GDSCImg09 from "@/public/images/client-logo-09.svg";
...
const testimonials = [
  {
    ...
    company: "GDSC Pune",
    content:
      "Being part of GDSC Pune has transformed my coding journey. The hands-on workshops and collaborative events made learning fun and impactful. The community is incredibly supportive!",
    categories: [1, 3, 5],
  },
  {
    img: GDSCImg02,
    ...
    content:
      "Joining GDSC Pune was one of the best decisions I've made. The mentorship sessions and tech talks helped me gain confidence and clarity in my career path.",
    categories: [1, 2, 4],
  },
  {
    img: GDSCImg03,
    ...
    company: "AIT Pune",
    content:
      "GDSC Pune introduced me to cutting-edge technologies and tools. The collaborative coding sessions were a game-changer for me!",
    categories: [1, 2, 5],
  },
  {
    img: GDSCImg04,
    ...
    company: "VIIT",
    content:
      "Thanks to GDSC Pune, I was able to build real-world projects and participate in hackathons with an amazing team. It's a great platform to grow your skills.",
    categories: [1, 4],
  },
  {
    img: GDSCImg05,
    ...
    company: "MIT Pune",
    content:
      "GDSC Pune has helped me connect with like-minded peers and industry experts. The knowledge-sharing sessions are top-notch!",
    categories: [1, 3, 5],
  },
  {
    img: GDSCImg06,
    ...
    company: "PICT",
    content:
      "The events organized by GDSC Pune have been both educational and inspiring. I feel more prepared to tackle real-world challenges now.",
    categories: [1, 3],
  },
  {
    img: GDSCImg07,
    ...
    company: "COEP",
    content:
      "I can't thank GDSC Pune enough for its contribution to my tech journey. The environment here is welcoming and filled with opportunities!",
    categories: [1, 2, 5],
  },
  {
    img: GDSCImg08,
    ...
    company: "SPPU",
    content:
      "GDSC Pune's initiatives have opened so many doors for me. I now feel more confident about applying for internships and working on projects.",
    categories: [1, 4],
  },
  {
    img: GDSCImg09,
    ...
    company: "AIT Pune",
    content:
      "Joining GDSC Pune has been a rewarding experience. The collaborative culture and opportunities to learn are unmatched.",
    categories: [1, 2],
  },
];
