...
import SecondaryIllustration from "@/GDSC-Assets-master/Backgrounds/backgrounds (2).png";
...
export default function ModalVideo({
  ...
  return (
    <div className="relative">
      <div
        className="pointer-events-none absolute bottom-8 left-1/2 -z-10 -ml-28 -translate-x-1/2 translate-y-1/2 m-auto"
        aria-hidden="true" 
      >
        {/* <Image
      ...
      <button
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-gradient-to-br before:from-yellow-200 before:via-indigo-500/20 before:to-gray-900">
          <Image
        ...
        {/* Play icon */}
        <span className="pointer-events-none absolute p-2.5 before:absolute before:inset-0 before:rounded-full before:bg-red-500 before:duration-300 group-hover:before:scale-110">
